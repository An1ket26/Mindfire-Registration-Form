...
namespace DataBase_LINQ
{
    ...
    public partial class WorldEntities : DbContext
    {
        ...
        [DbFunction("WorldEntities", "DetermineCustomerAccess")]
        public virtual IQueryable<DetermineCustomerAccess_Result> DetermineCustomerAccess(Nullable<int> cityID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DetermineCustomerAccess_Result>("[WorldEntities].[DetermineCustomerAccess](@CityID)", cityIDParameter);
        }
