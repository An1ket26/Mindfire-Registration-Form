...
namespace DataBase_LINQ
{
    ...
    public partial class AdventureEntity : DbContext
    {
        public AdventureEntity()
            : base("name=AdventureEntity")
        {
        }
        ...
        [DbFunction("AdventureEntity", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureEntity].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
