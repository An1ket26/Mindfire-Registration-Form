<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDetails.aspx.cs" Inherits="EmployeeManagements.Web.UserDetails" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form runat="server">
            ...
            <div class="container div-hide" id="container" >
                ...
                <div id="resultDiv" class="result-div">
                    ...
                    <div class="details">
                        ...
                        <div id="personalDetails" class="personal-details">
                            ...
                            <div class="div-col-30">
                                <span id="enteredDOB" objectname="Dob"></span>
                            </div>
                            <div class="div-col-20">Email :</div>
                            <div class="div-col-30">
